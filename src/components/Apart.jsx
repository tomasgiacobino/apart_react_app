    ...
    >
      ...
      >
        ...
        <div className="swipert">
          ...
          <div id="descNoMobile" className="description mt-28 mr-12 text-center top-0 right-0 z-[1] md:block hidden">
            <h2
        ...
        {/* <div
          ...
          className={`${
            modalOpen
              ? "md:hidden xs:hidden ssxs:hidden"
              : "xs:hidden md:block ssxs:hidden "
          } w-full`}
        >
            ...
            <div className=" flex flex-row w-full justify-around font-poppins">
              <a target="_blank" href={linkAirbnb}>
                <button className="w-20 relative flex items-center gap-5 text-white bg-verMas-gradient border-solid border-2 rounded-[12px] p-3 overflow-hidden group transition-all hover:w-64">
                  ...
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity absolute left-1/2 transform -translate-x-1/2 ml-6">
                    Reservar por Airbnb
                  </span>
                </button>
              </a>
              ...
              <a target="_blank" href={linkBooking}>
                <button
                  className="w-20 relative flex items-center gap-5 text-white bg-verMas-gradient border-solid border-2 rounded-[12px] p-3
         overflow-hidden group transition-all hover:w-64"
                >
                  <svg
                    ...
                    fill="none"
                    viewBox="0 0 14 14"
                    id="B--Streamline-Ultimate"
                  >
                    <path
                      fill="#3a279a"
                      fillRule="evenodd"
                      d="M4 0a1 1 0 0 0 -1 1v12a1 1 0 0 0 1 1h3.75a4.25 4.25 0 0 0 2.338 -7.8A3.75 3.75 0 0 0 7.25 0H4Zm3.25 5.5a1.75 1.75 0 1 0 0 -3.5H5v3.5h2.25ZM5 7.5V12h2.75a2.25 2.25 0 0 0 0 -4.5H5Z"
                      clipRule="evenodd"
                      strokeWidth={1}
                    />
                  </svg>
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity absolute left-1/2 transform -translate-x-1/2 ml-6">
                    Reservar por Booking
                  </span>
                </button>
              </a>
          ...
          <div className="flex flex-col justify-around items-center mt-10">
            <a target="_blank" href={linkAirbnb}>
              <button className="flex flex-row mb-5 items-center gap-4 text-white bg-verMas-gradient border-solid border-2 rounded-[12px] p-2">
                <svg
                  className={`${modalOpen ? "xs:hidden ssxs:hidden" : ""} h-9`}
                  viewBox="0 0 200.00 200.00"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#000000"
                  transform="rotate(0)"
            ...
            <a target="_blank" href={linkWpp}>
              <button className="flex flex-row mb-5 gap-4 text-white bg-verMas-gradient border-solid border-2 rounded-[12px] p-2">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  id="Whatsapp-Logo--Streamline-Ultimate"
                >
                  {" "}
                  <path
                    d="M12 0.09A12 12 0 0 0 0 12a11.73 11.73 0 0 0 2.14 6.77l-1.36 4a0.51 0.51 0 0 0 0.12 0.51 0.5 0.5 0 0 0 0.51 0.12l4.19 -1.33A11.94 11.94 0 1 0 12 0.09Zm7.2 16.72a3.9 3.9 0 0 1 -3.5 2.09 10.81 10.81 0 0 1 -3.46 -1 13.88 13.88 0 0 1 -5.94 -5.16c-1.92 -2.53 -2 -4.9 -0.17 -6.86a2.21 2.21 0 0 1 1.92 -0.56 1.53 1.53 0 0 1 1.2 0.88l0.39 0.92 0.63 1.51a1.1 1.1 0 0 1 0 1 5.19 5.19 0 0 1 -1 1.37 12.83 12.83 0 0 0 1.8 2.14 9 9 0 0 0 2.73 1.64c0.28 -0.37 0.82 -1 1 -1.28a1 1 0 0 1 1.34 -0.35c0.38 0.13 2.51 1.18 2.51 1.18a1.37 1.37 0 0 1 0.68 0.49 2 2 0 0 1 -0.13 1.99Z"
