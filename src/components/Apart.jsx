    ...
    <section id='apart1' className={`flex flex-col md:mt-14 mt-5 ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col items-center w-full text-center justify-between xl:px-0 sm:px-16 px-6`}>
        <h2 className='flex md:flex-row flex-col 
          ...
          <span
            className='text-gradient'> Apart {id}
          </span> {" "}
        </h2>
        ...
        <div className='flex md:flex-row flex-col  mt-10'>
          <div className='md:mr-10 mr-0 md:mb-0 mb-10'>
            <img className='border-solid border-2 border-black rounded-[12px]' src={p1} alt="foto de una cama doble del apart 1" />
          </div>

          <div className=''>
            <img className='border-solid border-2 border-black rounded-[12px]' src={p2} alt="foto de una cama sofa del apart 1" />
          </div>
        ...
        <Modal titleModal={titleModal} photosModal={photosModal} isOpen={modalOpen} onClose={toggleModal} />


        <div id='btns' className={`${modalOpen ? 'md:hidden xs:hidden ssxs:hidden' : 'xs:hidden md:block ssxs:hidden '} w-full`} >
          <div id='btns' className='w-full'>
