  ...
  return (
    ...
    ss:text-[40px] text-[30px]
     text-white gap-4'>
        ...
        <h4 className={`${styles.paragraph} mt-5`}>Este apartamento está diseñado para alojar cómodamente a cuatro huéspedes,
         con un dormitorio que ofrece dos camas dobles, un baño y una zona de trabajo.
         Además, cuenta con servicios como wifi, aire acondicionado, televisor y secador de pelo.</h4>


        <div className='flex md:flex-row flex-col  mt-10'>
          <div className='md:mr-10 mr-0 md:mb-0 mb-10'>
            <img className='border-solid border-2 border-black rounded-[12px]' src={camas1} alt="foto de dos camas dobles del apart 3" />
          </div>

          <div className=''>
            <img className='border-solid border-2 border-black rounded-[12px]' src={camasinvertidasluz} alt="foto de dos camas dobles del apart 3 " />
          </div>
