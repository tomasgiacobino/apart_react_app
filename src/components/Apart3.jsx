...
import camas1 from '../assets/cuarto3/camas1.webp';
import camasinvertidasluz from '../assets/cuarto3/camasinvertidasluz.webp';

import camas2 from "../assets/cuarto3/camas2.webp";
import tele from "../assets/cuarto3/tele.webp"
import detalle from "../assets/cuarto3/detalle.webp";
import espejo from "../assets/cuarto3/espejo.webp";
import lampara from "../assets/cuarto3/lampara.webp";
import baño from "../assets/cuarto3/baño.webp";
import patio from "../assets/cuarto3/patio.webp";
import patio1 from "../assets/cuarto3/patio1.webp";
import ventana from "../assets/cuarto3/ventana.webp";
import ventana2 from "../assets/cuarto3/ventana2.webp";
import camas from "../assets/cuarto3/camas.webp";
...
const Apart3 = () => {
  ...
  const title = "Terra María Apart 3";

  const photos = [
    { original: camas2, thumbnail: camas2 },
    { original: tele, thumbnail: tele },
    { original: detalle, thumbnail: detalle },
    { original: espejo, thumbnail: espejo },
    { original: lampara, thumbnail: lampara },
    { original: baño, thumbnail: baño },
    { original: patio, thumbnail: patio },
    { original: patio1, thumbnail: patio1 },
    { original: ventana, thumbnail: ventana },
    { original: ventana2, thumbnail: ventana2 },
    { original: camas, thumbnail: camas},
  ];

  return (
    <section id='apart3' className={`flex flex-col mt-5 ${styles.paddingY}`}>
    ...
    ss:text-[40px] text-[30px]
     text-white gap-4'>
          ...
          <span
            className='text-gradient'>Apart 3
          </span> {" "}
        </h2>


        <h4 className={`${styles.paragraph} mt-5`}>Este apartment esta pensado para 4 huespedes, en el que podes encontrar 1 dormitorio, 2 camas, 1 baño y una zona de trabajo. Ademas incluye servicios
          como Wifi, Aire acondicionado, Televisor, Secador de pelo.</h4>


        <div className='flex md:flex-row flex-col  mt-10'>
          <div className='md:mr-10 mr-0 md:mb-0 mb-10'>
            <img className='border-solid border-2 border-black rounded-[12px]' src={camas1} alt="" />
          </div>

          <div className=''>
            <img className='border-solid border-2 border-black rounded-[12px]' src={camasinvertidasluz} alt="" />
          </div>
        ...
        <button
          ...
          className="text-white mt-10 md:mb-10 mb-2 bg-verMas-gradient
                ...
                border-solid border-2 rounded-[12px] p-2"
        >
          Ver Más Fotos
        </button>
        ...
        <div id='btns' className={`${modalOpen ? 'md:hidden xs:hidden ssxs:hidden' : 'xs:hidden md:block ssxs:hidden '} w-full`}>
          <div className='flex flex-row w-full justify-around'>
            <a target='_blank' href="https://www.airbnb.com.ar/rooms/745007841653857708?_set_bev_on_new_domain=1681475889_ZTFkMzI0OWE3Mjdi&source_impression_id=p3_1708396527_0GNFlDQB9%2B%2FqZKoy">
         ...
         overflow-hidden group transition-all hover:w-64'>
            ...
            <a target='_blank' href="https://wa.me/3874069341?text=Hola,%20estoy%20interesado%20en%20el%20apart%203%20de%20Terra%20Maria%20Apartment">
              <button className='w-20 relative flex items-center gap-5 text-white bg-verMas-gradient border-solid border-2 rounded-[12px] p-3
         overflow-hidden group transition-all hover:w-64'>
