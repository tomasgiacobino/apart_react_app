...
import cama1 from '../assets/cuarto4/cama1.webp';
import cuarto2 from '../assets/cuarto4/cuarto2.webp';

import cuarto1 from "../assets/cuarto4/cuarto1.webp";
import cuarto from "../assets/cuarto4/cuarto.webp";
import esquina1 from "../assets/cuarto4/esquina1.webp";
import mesa from "../assets/cuarto4/mesa.webp";
import detalle from "../assets/cuarto4/detalle.webp";
import esquina from "../assets/cuarto4/esquina.webp";
import cama2 from "../assets/cuarto4/cama2.webp";
import cuarto3 from "../assets/cuarto4/cuarto3.webp";
import baño from "../assets/cuarto4/baño.webp";
import baño1 from "../assets/cuarto4/baño1.webp";
...
const Apart4 = () => {
  ...
  const title = "Terra María Apart 4";

  const photos = [
    { original: cuarto1, thumbnail: cuarto1 },
    { original: cuarto, thumbnail: cuarto },
    { original: esquina1, thumbnail: esquina1 },
    { original: mesa, thumbnail: mesa },
    { original: detalle, thumbnail: detalle },
    { original: esquina, thumbnail: esquina },
    { original: cama2, thumbnail: cama2 },
    { original: cuarto3, thumbnail: cuarto3 },
  ...
  <section id='apart3' className={`flex flex-col mt-5 ${styles.paddingY}`}>
    ...
    ss:text-[40px] text-[30px]
     text-white gap-4'>
        ...
        <span
          className='text-gradient'>Apart 4
        </span> {" "}
      </h2>
      ...
      <button
        ...
        <div className='flex flex-row w-full justify-around'>
          <a target='_blank' href="https://www.airbnb.com.ar/rooms/819352501400878741?_set_bev_on_new_domain=1681475889_ZTFkMzI0OWE3Mjdi&source_impression_id=p3_1707437984_kGXVAxguzRRYcufT">
         ...
         overflow-hidden group transition-all hover:w-64'>
          ...
          <a target='_blank' href="https://wa.me/3874069341?text=Hola,%20estoy%20interesado%20en%20el%20apart%204%20de%20Terra%20Maria%20Apartment">
            <button className='w-20 relative flex items-center gap-5 text-white bg-verMas-gradient border-solid border-2 rounded-[12px] p-3
         overflow-hidden group transition-all hover:w-64'>
